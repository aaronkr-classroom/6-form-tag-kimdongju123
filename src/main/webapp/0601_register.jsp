...
<p>이메일: <input type="text" name="email" placeholder="me@site.com">
</p>
...
<input type="checkbox" name="hobby2" checked>운동
<input type="checkbox" name="hobby3" checked>영화
</p>
<hr>
<p>구역:
...
<hr>
<p>
<textarea names="comment" cols=30 rows=5>가입 인사를 입력해주세요~~
</textarea>
</p>
<p>
